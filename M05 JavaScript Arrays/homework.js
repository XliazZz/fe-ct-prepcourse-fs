...
function mayorACien(array) {
   ...
   // Tu código:
   var arrayMayoresDe100 = [];
   for (var i = 0; i < array.length; i++) {
      if (array[i] > 100) {
         arrayMayoresDe100.push(array[i])
      }
   }return arrayMayoresDe100;
}
...
function breakStatement(num) {
   ...
   for(var i = 1; i < 11; i++) {
      ...
      if (suma === i) {
         ...
         arrayDeNuevoValor.push(suma);
      }
   }
   if (arrayDeNuevoValor.length < 10) {
      return 'Se interrumpió la ejecución';
   } else if (arrayDeNuevoValor.length === 10) {
      return arrayDeNuevoValor;}
}
